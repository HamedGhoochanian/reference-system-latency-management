...
int main(int argc, char * argv[])
{
  ...
  // Create callbacks
  auto c1_t_cb = std::make_shared<StartNode>(
    "Timer_callback", "c1", trace_callbacks, 100, 1000,
    false);
  auto c1_r_cb_1 = std::make_shared<IntermediateNode>(
    "Regular_callback1", "c1", "",
    trace_callbacks, 100, true);
  auto c1_r_cb_2 = std::make_shared<IntermediateNode>(
    "Regular_callback2", "c1", "",
    trace_callbacks, 100, true);
  auto c1_r_cb_3 = std::make_shared<IntermediateNode>(
    "Regular_callback3", "c1", "",
    trace_callbacks, 100, true);
  ...
  rclcpp::executors::MultiThreadedExecutor exec1(rclcpp::ExecutorOptions(), number_of_threads,
    true);
  ...
  RCLCPP_INFO(
    ...
    exec1.callback_priority_enabled ? "Enabled" : "Disabled");
  ...
  RCLCPP_INFO(
    rclcpp::get_logger(
      "rclcpp"), "PiCAS executor 1's rt-priority %d and CPU %d", exec1.executor_priority,
    exec1.executor_cpu);
#endif
  ...
  RCLCPP_INFO(
    rclcpp::get_logger(
      "rclcpp"), "Timer_callback->priority: %d", c1_t_cb->timer_->callback_priority);
  RCLCPP_INFO(
    rclcpp::get_logger(
      "rclcpp"), "Regular_callback1->priority: %d", c1_r_cb_1->subscription_->callback_priority);
  RCLCPP_INFO(
    rclcpp::get_logger(
      "rclcpp"), "Regular_callback2->priority: %d", c1_r_cb_2->subscription_->callback_priority);
  RCLCPP_INFO(
    rclcpp::get_logger(
      "rclcpp"), "Regular_callback3->priority: %d", c1_r_cb_3->subscription_->callback_priority);
#endif
