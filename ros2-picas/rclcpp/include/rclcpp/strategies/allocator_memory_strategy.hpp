...
public:
    ...
    const WeakCallbackGroupsToNodesMap & weak_groups_to_nodes) override
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger(
        "rclcpp"), "[get_next_subscription] subscription_handles_.size: %d",
      ...
      if (subscription) {
        ...
        if (callback_priority_enabled) {
          if (any_exec.subscription == nullptr ||
            subscription->callback_priority > highest_priority)
          {
          ...
          RCLCPP_INFO(
            rclcpp::get_logger(
              "rclcpp"), "[get_next_subscription found (node name: %s)",
    ...
    if (any_exec.subscription) {
      RCLCPP_INFO(
        rclcpp::get_logger("rclcpp"), "[get_next_subscription] found (node name: %s, prio: %d)",
    ...
    const WeakCallbackGroupsToNodesMap & weak_groups_to_nodes) override
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger(
        "rclcpp"), "[get_next_service] service_handles_.size: %d", service_handles_.size());
    #endif
#endif
    while (it != service_handles_.end()) {
      ...
      if (service) {
        ...
        if (callback_priority_enabled) {
          ...
          RCLCPP_INFO(
            rclcpp::get_logger(
              "rclcpp"), "[get_next_service] found (node name: %s)",
            any_exec.node_base->get_name());
          #endif
          return;
        }
    ...
    if (any_exec.service) {
      RCLCPP_INFO(
        rclcpp::get_logger("rclcpp"), "[get_next_service] found (node name: %s, prio: %d)",
    ...
    const WeakCallbackGroupsToNodesMap & weak_groups_to_nodes) override
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger(
        "rclcpp"), "[get_next_client] client_handles_.size: %d", client_handles_.size());
    #endif
#endif
    ...
    while (it != client_handles_.end()) {
      ...
      if (client) {
        ...
        if (callback_priority_enabled) {
          ...
          RCLCPP_INFO(
            rclcpp::get_logger(
              "rclcpp"), "[get_next_client] found (node name: %s)",
            any_exec.node_base->get_name());
          #endif
          return;
        }
    ...
    if (any_exec.client) {
      RCLCPP_INFO(
        rclcpp::get_logger("rclcpp"), "[get_next_client] found (node name: %s, prio: %d)",
    ...
    const WeakCallbackGroupsToNodesMap & weak_groups_to_nodes) override
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger(
        "rclcpp"), "[get_next_timer] timer_handles_.size: %d", timer_handles_.size());
    #endif
#endif
    ...
    while (it != timer_handles_.end()) {
      ...
      if (timer) {
        ...
        if (callback_priority_enabled) {
          ...
          RCLCPP_INFO(
            rclcpp::get_logger(
              "rclcpp"), "[get_next_timer] found (node name: %s)",
            any_exec.node_base->get_name());
          #endif
          return;
        }
    ...
    if (any_exec.timer) {
      RCLCPP_INFO(
        rclcpp::get_logger("rclcpp"), "[get_next_timer] found (node name: %s, prio: %d)",
    ...
    const WeakCallbackGroupsToNodesMap & weak_groups_to_nodes) override
  {
    ...
    RCLCPP_INFO(
      rclcpp::get_logger(
        "rclcpp"), "[get_next_waitable] waitable_handles_.size: %d", waitable_handles_.size());
    #endif
#endif
    ...
    while (it != waitable_handles_.end()) {
      ...
      if (waitable) {
        ...
        if (callback_priority_enabled) {
          ...
          RCLCPP_INFO(
            rclcpp::get_logger(
              "rclcpp"), "[get_next_waitable] found (node name: %s)",
            any_exec.node_base->get_name());
          #endif
          return;
        }
    ...
    if (any_exec.waitable) {
      RCLCPP_INFO(
        rclcpp::get_logger("rclcpp"), "[get_next_waitable] found (node name: %s, prio: %d)",
